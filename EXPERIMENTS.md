...
| `heterogeneous-correlation-fat-tails` | `96b48dc` | 1, the one-sided validity rule — `5b8042c`; 2, cell (B) pinned and a replication branch — `6739589`; 3, cell (A) needs rho>0 and two nulls per draw — `7cc4c67` |
