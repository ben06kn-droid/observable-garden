...
Pre-registered in prereg/E21.md, committed before this ran. Table 1 of the note, and its gate: every
result from E15 on says the realized-menu bootstrap fails when a search builds candidates from its own
...
K only, as the oblivious-generation / adaptive-selection control (SCOPE.md section 4).

Usage: python -m experiments.e21_oblivious_calibration [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/e21_oblivious_calibration_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/e21_checkpoints")
