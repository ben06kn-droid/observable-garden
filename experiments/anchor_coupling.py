...
Background. SCOPE.md, Winner-chasing reported that NeighborAdaptive, whose round-2 anchor
...
Settings as in SCOPE.md, Winner-chasing's dose-response run: K=20, M=50, T=500, rho=0.3,
...
Usage: python -m experiments.anchor_coupling [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/anchor_coupling_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/anchor_coupling_checkpoints")
