...
obliviousness claim in SCOPE.md, The obliviousness condition is stated generally while tested at one
...
experiments/signal_landscape_pilot.py, which confirmed this DGP is not
...
Usage: python -m experiments.predictive_power_v1
"""
...
if __name__ == "__main__":
    ...
    report(results)
    with open("figures/predictive_power_v1_data.pkl", "wb") as f:
