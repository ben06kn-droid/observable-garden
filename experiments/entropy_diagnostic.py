...
Reuses the exact same seeds/config as experiments/dose_response_beam.py so
...
Usage: python -m experiments.entropy_diagnostic --n-draws 150
"""
...
if __name__ == "__main__":
    ...
    with open("figures/entropy_diagnostic_data.pkl", "wb") as f:
