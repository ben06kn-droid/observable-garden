...
e9's pooled figure (passing results overstate the true Sharpe by 1.84x) is
...
Design: e10's regime (rho=0, K=40, M=60, T=600, GridSearch over subsets up
...
Usage: python -m experiments.e12_type_m_by_power
"""
...
if __name__ == "__main__":
    ...
    report(rows)
    with open("figures/e12_type_m_by_power_data.pkl", "wb") as f:
