...
(experiments/dgp_criterion_check.py), which ran and was read BEFORE this
...
experiments/predictive_power_v1.py (the original, equicorrelation +
...
Usage: python -m experiments.predictive_power
"""
...
if __name__ == "__main__":
    ...
    report(results)
    with open("figures/predictive_power_data.pkl", "wb") as f:
