"""Fixes a real confound in experiments/power_vs_signal.py,
...
Usage: python -m experiments.power_vs_breadth_pinned [--workers N] [--checkpoint-dir DIR]
"""
...
RHO = 0.0   # same clean regime as power-vs-signal, for direct comparison
K = 40
...
if __name__ == "__main__":
    ...
    report(results)
    with open("figures/power_vs_breadth_pinned_data.pkl", "wb") as f:
