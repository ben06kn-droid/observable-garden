...
experiments/procedure_spotcheck.py for that, at reduced n/B on a
...
Usage: python -m experiments.dose_response_beam --n-draws 300
"""
...
if __name__ == "__main__":
    ...
    import pickle
    with open("figures/dose_response_beam_data.pkl", "wb") as f:
