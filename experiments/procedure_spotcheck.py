...
response sweep (experiments/dose_response_beam.py). Not run for all 7
...
see SCOPE.md, The obliviousness condition), so a reconstruction-free check adds nothing there.
Adaptive (k=1) was already validated this way at n=500
(experiments/adaptive_powered.py vs the original oracle bootstrap). This
...
Usage: python -m experiments.procedure_spotcheck
"""
