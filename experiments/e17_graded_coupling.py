...
Pre-registered in prereg/E17.md, committed before this ran. GumbelAnchored(tau) spans loser (-inf),
...
Usage: python -m experiments.e17_graded_coupling [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/e17_graded_coupling_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/e17_checkpoints")
