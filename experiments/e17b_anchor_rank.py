...
Pre-registered in prereg/E17b.md, committed before this ran. RankAnchor(k) fixes round 2's anchor at the
k-th best single feature; each draw builds the naive and recursive nulls on common resampled indices.

Usage: python -m experiments.e17b_anchor_rank [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
RANKS = (1, 2, 3, 5, 10, 20)
LIMIT = {1: 0.091, 2: 0.091, 3: 0.066, 5: 0.049, 10: 0.043, 20: 0.043}   # prereg/E17b.md, Gaussian limit
METHODS = ("p_naive", "p_recursive")
FIELDS = (*METHODS, "kappa", "anchor", "winner", "sr_sel", "block_length")
OUTPUT = "figures/e17b_anchor_rank_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/e17b_checkpoints")
