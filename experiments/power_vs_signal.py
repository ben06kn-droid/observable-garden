"""Corrects a conflation in predictive-power's power numbers: power rising with rho
...
(SCOPE.md, The headline cell's main table).

Usage: python -m experiments.power_vs_signal
"""
...
if __name__ == "__main__":
    results = run()
    report(results)
    with open("figures/power_vs_signal_data.pkl", "wb") as f:
