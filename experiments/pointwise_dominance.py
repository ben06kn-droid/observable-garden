"""pointwise-dominance: does the P4 lemma's pointwise dominance explain anchor-coupling's winner inflation?

Pre-registered at c8c5d60, before this ran. For winner- and
...
Usage: python -m experiments.pointwise_dominance [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/pointwise_dominance_data.pkl"
...
def report(data: dict) -> None:
    ...
    if primary >= GATE_PASS:
        verdict = "P4 supported as the mechanism: proceed to graded-coupling through full-class-power"
    elif primary < GATE_STOP:
        verdict = "P4 is not the mechanism behind anchor-coupling: pause graded-coupling through full-class-power and rethink §4 of the note"
    else:
        verdict = "ambiguous (0.80-0.90): decide explicitly before running graded-coupling"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/pointwise_dominance_checkpoints")
