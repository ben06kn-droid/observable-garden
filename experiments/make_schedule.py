...
def main() -> None:
    rows = build()
    verify(rows)
    print("# seed  config  arm      budget")
    print("# amendment 4, seeds 80-319. Generated by experiments/make_schedule.py;")
    print("# regenerate rather than edit. Quotas verified against the amendment.")
    for seed, cfg, arm, bud in rows:
        print(f"{seed:<6} {cfg:<7} {arm:<8} {bud if bud is not None else '-'}")
