...
SCOPE.md, Sparse strategies: re-estimating Sharpe in every replicate lets rarely-trading
...
Usage: python -m experiments.degeneracy_calibration
"""
...
if __name__ == "__main__":
    ...
    with open("figures/degeneracy_calibration_data.pkl", "wb") as f:
