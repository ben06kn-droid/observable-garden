...
Pre-registered in prereg/E20.md, committed before this ran. Moving-average crossover rules on driftless
...
Usage: python -m experiments.e20_non_additive [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/e20_non_additive_data.pkl"
...
def run_draw(world: str, seed: int) -> dict:
    ...
    # One block length for every bootstrap null, taken from the class, as in E17-E19.
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/e20_checkpoints")
