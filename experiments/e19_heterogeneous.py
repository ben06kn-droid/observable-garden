...
Pre-registered in prereg/E19.md, committed before this ran. Arm (a): winner anchoring under a single-factor
...
Usage: python -m experiments.e19_heterogeneous [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
FIELDS = (*METHODS, "dominance", "mean_gap", "worst_gap", "kappa", "stability", "top_loading",
          "sr_sel", "block_length")
LIMIT = {"winner_het_K20": 0.0914, "winner_het_K80": 0.1438}   # prereg/E19.md, Gaussian limit
OUTPUT = "figures/e19_heterogeneous_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/e19_checkpoints")
