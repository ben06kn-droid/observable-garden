"""feature-count: does naive inflation grow with the number of candidate features?

Pre-registered at 21dbbc1, before this ran. A winner-anchored depth-2 search sees the first
...
Usage: python -m experiments.feature_count [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
from experiments.graded_coupling import trend_test
...
TREND_ALPHA = 0.01
LIMIT = {0.0: {10: 0.101, 20: 0.155, 40: 0.242, 80: 0.357},    # feature-count's prereg, 21dbbc1, Gaussian limit
         0.3: {10: 0.073, 20: 0.091, 40: 0.113, 80: 0.137}}
METHODS = ("p_naive", "p_recursive", "p_full_class")
FIELDS = (*METHODS, "sr_sel", "block_length")
OUTPUT = "figures/feature_count_data.pkl"
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", default=".cache/feature_count_checkpoints")
