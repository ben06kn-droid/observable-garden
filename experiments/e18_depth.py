...
Pre-registered in prereg/E18.md, committed before this ran. Anchor rules at d=3 on n=1,000 paired draws;
e5's dose axis and DepthAdaptive on the first 500 of the same draws. Each draw builds the naive,
...
Usage: python -m experiments.e18_depth [--workers N] [--checkpoint-dir DIR] [--smoke]
"""
...
OUTPUT = "figures/e18_depth_data.pkl"
